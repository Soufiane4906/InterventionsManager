...
import AddSubIntervention from "./AddSubIntervention";
import ConfirmatioDialog from "../Dialogs";

const InterventionDialog = ({ intervention }) => {
  ...
  const items = [
    {
      ...
      onClick: () => navigate(`/intervention/${intervention._id}`),
    },
    {
      label: "Edit",
  ...
  return (
    <>
      ...
      <AddSubIntervention open={open} setOpen={setOpen} />
