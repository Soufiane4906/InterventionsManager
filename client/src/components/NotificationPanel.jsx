...
const data = [
  {
    ...
    text: "New intervention has been assigned to you and 2 others. The intervention priority is set a normal priority, so check and act accordingly. The intervention date is Thu Feb 29 2024. Thank you!!!",
    intervention: null,
    notiType: "alert",
    isRead: [],
  ...
  },
  {
    ...
    text: "New intervention has been assigned to you and 2 others. The intervention priority is set a high priority, so check and act accordingly. The intervention date is Fri Feb 09 2024. Thank you!!!",
    intervention: {
